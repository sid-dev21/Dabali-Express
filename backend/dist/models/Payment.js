...
const PaymentSchema = new mongoose_1.Schema({
    subscription_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Subscription', required: true },
    parent_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
