...
// Create student (SCHOOL_ADMIN, CANTEEN_MANAGER, PARENT)
router.post('/', requireRole(UserRole.SCHOOL_ADMIN, UserRole.CANTEEN_MANAGER, UserRole.PARENT), createStudent);
